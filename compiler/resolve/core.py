...
class Resolver:
    ...
    def _install_builtins(self, module: ModuleInfo) -> None:
        for name in ("print_line", "read_file", "io_err_text", "str_len", "str_get", "str_slice", "str_concat", "list", "list_push", "list_len", "list_get"):
    ...
    def _wire_imports(self, module: ModuleInfo, scope: ModuleScope, program: ast.Program) -> None:
        for item in program.items:
            ...
            scope.hidden_functions.update(set(imported_scope.functions) - set(imported_scope.exported_functions) - {"print_line", "read_file", "io_err_text", "str_len", "str_get", "str_slice", "str_concat", "list", "list_push", "list_len", "list_get"})
